...
networkConstruction = "datasets/GSE72326_wgcna_networkConstruction.rda"
## 输出文件
dataOutput = "datasets/GSE72326_wgcna_Modules_Genes.csv"
...
geneInfo0 = data.frame(geneSymbol = symbols,
...
write.csv(geneInfo, file = dataOutput)
